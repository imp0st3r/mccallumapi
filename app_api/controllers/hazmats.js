...
module.exports.getReturnHMDoc = function(req,res){
                ...
                {stack: [
                        {
                            table: {
                                ...
                                body: [
                                    [
                                        {
                                            text:Math.ceil((items[i].quantity_received - items[i].quantity_used) / items[i].item.case_size),
                                            fontSize: 8
                                        }, 
                                        {
                                            text:(items[i].quantity_received - items[i].quantity_used),
                                            fontSize: 8
                                        },
                                        {
                                            text: items[i].item.unit_type,
                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        ...
                                        {
                                            text:(items[i].quantity_received - items[i].quantity_used) * items[i].item.weight_each,
                                            fontSize: 8
                                        }
                                    ]
                                ]
    ...
    var lastName = "assets/hazmats/HM_RP_"+req.body.customer_name+"_"+today+".pdf";
